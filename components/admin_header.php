<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="manage_doctor.php"><i class="fas fa-building"></i><span>Manage Doctor</span></a>
      <!-- <a href="manage_patient.php"><i class="fas fa-user"></i><span>Manage Patient</span></a> -->
